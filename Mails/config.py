...
docs_path = 'data/test.csv' # original documents
...
model_path = 'data/model/emails_topic.model' # make sure to have .gensim.state file in the same folder as well
dictionary_path = 'data/model/emails_topic.dict' #gensim dictionary
...
num_topics = 3 # number of topics for your gensim model
